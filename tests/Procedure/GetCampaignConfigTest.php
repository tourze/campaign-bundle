 ...
 * @internal
 */
#[CoversClass(GetCampaignConfig::class)]
#[RunTestsInSeparateProcesses]
final class GetCampaignConfigTest extends AbstractProcedureTestCase
{
    ...
    {
        // 验证 execute 方法的返回类型
        $reflection = new \ReflectionMethod(GetCampaignConfig::class, 'execute');
