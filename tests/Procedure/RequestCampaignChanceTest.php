 ...
 * @internal
 */
#[CoversClass(RequestCampaignChance::class)]
#[RunTestsInSeparateProcesses]
final class RequestCampaignChanceTest extends AbstractProcedureTestCase
{
    ...
    {
        // 验证 execute 方法的返回类型
        $reflection = new \ReflectionMethod(RequestCampaignChance::class, 'execute');
